    ...
    public class EmailTitle
    {
        ...
        public string SendVerifyEmail(string email)
        {
            string text = $@"
                            ...
                            <p>Để kích hoạt tài khoản của bạn , vui lòng nhấn vào nút để kích hoạt <a href='https://localhost:44303/verify-email'>Kích hoạt tài khoản</a> để kích hoạt tài khoản</p>
